...
from .AttTreeModel import SpatialAttTreeModel
from .ShowTellTreeModel import ShowTellTreeModel
...
def setup(opt):
    ...
    # Tree model
    print("using caption model: {}".format(opt.caption_model))
    if opt.caption_model == 'tree_att':
        model = SpatialAttTreeModel(opt)
    elif opt.caption_model == 'show_tell_tree':
